          ...
          <b-col lg="5" md="7">
            ...
            <b-row class="mt-3">
              ...
              <b-col cols="6" class="text-right">
                <a :href="route('register.index')" target="_blank" class="text-light float-right"><small>Create new account</small></a>
              </b-col>
            </b-row>
          </b-col>
        </b-row>
...
export default {
  ...
  methods: {
    onSubmit() {
      this.$inertia.post(route('subdomain.login.post', subdomain), this.model)
    }
  }
}
</script>
